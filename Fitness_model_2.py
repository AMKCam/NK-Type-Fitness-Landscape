...
#seq_len = []
        ...
        gen_count += 1
        while gen_count < gen:   #run for x generations
            pop_seq = []
            pop_fit = []
  ...
  #  seq_len.append(gen_dic_seq)
   ...
   # sim_round[num_sim] = gen_dic_fit
    ...
    #plt.savefig("Fit_model_2_5_sims_len_60_100_seq_per_gen_10000_gen_T_and_C_0_fit.png", dpi=300)
    #plt.savefig("Fit_model_2_5_sims_A_G_con_len_60_100_seq_per_gen_10000_gen_T_and_C_0_fit.png", dpi=300)
    plt.savefig("Fit_model_2_5_sims_Hamming_distance_len_60_100_seq_per_gen_1000_gen_T_and_C_0_fit.png", dpi=300)
