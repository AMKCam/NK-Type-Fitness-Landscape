...
def dna_fit_model(r,n,sim,pop_size,gen):
  ...
  #  seq_len.append(gen_dic_seq)
   ...
   # sim_round[num_sim] = gen_dic_fit
    ...
    plt.savefig("Fit_model_5_5_mut_epi_K_2_5_sims_len_300_100_seq_per_gen_1000_gen.png", dpi=300)
    #plt.savefig("Fit_model_5_1_mut_epi_K_2_5_sims_Hamming_distance_len_300_100_seq_per_gen_1000_gen.png", dpi=300)
