...
def fit_assign(func,fit_dic):
    ...
    for seq in func: #loops over seq list generated by ran_dna_seq function
        ...
        #fit_assign_dic[seq] = fit_per #assigns seq prob to dictionary
        fit_assign_dic[seq] = fit_prob
...
#seq_len = []
        ...
        init_A_G_con = aver_A_G_con(init_fit)
        A_G_con_list.append(init_A_G_con)
        print("Initial pop A/G content is ", init_A_G_con)
        ...
        while gen_count < gen:   #initially run it for 10 generations
            ...
            rem.update(new_fit)
            A_G_con = aver_A_G_con(rem)
            A_G_con_list.append(A_G_con)
            print("Generation ", gen_count, " average A/G content is ", A_G_con)
  ...
  #  seq_len.append(gen_dic_seq)
   ...
   # sim_round[num_sim] = gen_dic_fit
    ...
    #plt.savefig("Fit_model_3_5_sims_len_300_10_seq_per_gen_1000_gen_T_and_C_0_fit.png", dpi=300)
    #plt.savefig("Fit_model_2_5_sims_A_G_con_len_300_10_seq_per_gen_100_gen_T_and_C_0_fit.png", dpi=300)
    plt.savefig("Fit_model_3_3_sims_Hamming_distance_len_300_100_seq_per_gen_1000_gen_T_and_C_0_fit.png", dpi=300)
